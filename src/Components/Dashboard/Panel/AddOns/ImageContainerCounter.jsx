  ...
  return (
    <div className="eightyfivepercent flex gap-4 mb-4 ">
      <div className="w-1/3 relative">
        ...
        <div className="bg-main-100 absolute p-1 top-0 right-1 rounded-tr-lg rounded-bl-lg">
          منتظر بررسی
        </div>
      ...
      <div className="w-1/3 relative">
        ...
        <div className="bg-main-100 absolute p-1 flex justify-center items-center top-0 right-0 rounded-tr-lg rounded-bl-lg">
          اجاره شده ها{" "}
        </div>
        <span className="text-white absolute top-1/2 left-1/2 text-5xl">5</span>
      </div>
